...
2. **Look Up** — paste an issue key (e.g. `PROJ-42`) or a full Jira URL; the app fetches a preview with summary, type, status, and assignee
...
- **Icons:** [Tabler Icons](https://github.com/tabler/tabler-icons), used under the [MIT License](https://github.com/tabler/tabler-icons/blob/main/LICENSE)
